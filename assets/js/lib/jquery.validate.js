...
$.extend( $.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format( "Digite não mais que {0} caracteres." ),
		minlength: $.validator.format( "Digite pelo menos {0} caracteres." ),
		rangelength: $.validator.format( "Digite um valor entre {0} e {1} caráter longo." ),
		range: $.validator.format( "Digite um valor entre {0} e {1}." ),
		max: $.validator.format( "Por favor insira um valor maior que ou igual a {0}." ),
		min: $.validator.format( "Por favor insira um valor menor que ou igual a {0}." ),
